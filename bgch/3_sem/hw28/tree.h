...
class tree
{
    ...
    public:
        ...
        //int numOfElementsInSubtreesWithNotMoreThanKLevels(tree_node *p, int *num, int *max_levels, int num_levels, int levels, int k); // 3
        int numOfElementsInSubtreesWithNotMoreThanKLevels(tree_node *p, int *num, int *levels, int k); // 3
        int numOfElementsOnKLevelRoot(int k); // 5
